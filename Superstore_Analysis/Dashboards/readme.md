...
> Sales by Region:
- East region --> highest sales (32%).
- West region --> lowest sales (20%).
- East and South together account over half of total sales.
- Sales are fairly distributed across all regions.

> Sales by Category
- Technology --> top-selling category (836K).
- Furniture --> second-highest sales (742K).
- Office Supplies sales are close to Furniture (719K).
- All categories contribute significantly to total sales.

> Profit by Segment
- Consumer segment --> highest profit (47%) --> most profitable group.
- Corporate segment contributes one-third of total profit.
- Home Office --> lowest profit share (21%).

> Profit by Category
- Technology --> highest profit (145K) --> best-performing category in both sales and profit.
